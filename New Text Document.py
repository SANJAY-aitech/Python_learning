...
def index():
    ...
    available_students = []
    try:
        df = load_excel_data('/home/sanjayaitech/class_details/merged_output.xlsx')
            ...
            if df is not None and not df.empty:
                ...
                if result:
                    ...
                    for ext in possible_extensions:
                        relative_path = f"images/Student_Photos/{register_no}{ext}"
                        ...
                        if os.path.exists(absolute_path):
                            ...
                            break
                    if not image_found:
                        print(f"No image found for register number: {register_no}")
                else:
                    error_message = f"No student found with Register No:{register_no}"
            else:
                error_message = "Excel data could not be loaded properly.Please check file format."
        except Exception as e:
